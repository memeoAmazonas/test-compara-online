  <h3 align="center">ComparaOnline Test Requirements Specification</h3>
...
1. Clone the repo
   ```sh
   git clone https://github.com/memeoAmazonas/test-compara-online.git
   ```
...
## execution-mode
 ```sh
   ...
   ```
In the [Folder](https://github.com/memeoAmazonas/test-compara-online/tree/main/src/data) there is the file after-30-days.json generated by the execution of the application 
<!-- DEVELOP MODE -->
## test-mode
 ```sh
   npm run test
   ```
On the path "/coverage" test reports are found<br><br>
In the [Folder](https://github.com/memeoAmazonas/test-compara-online/tree/main/src/data) there is the file data-test.js, which contains some test cases  
<!-- CONTACT -->
## Contact
